...
public class Opcode {
	...
	public static short ADCZ = 0x65; // ADC Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short ADCZX = 0x75; // ADC Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short ADCA = 0x6D; // ADC Absolute; 3 bytes, 4 cycles
	public static short ADCAX = 0x7D; // ADC Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short ADCAY = 0x79; // ADC Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short ADCIX = 0x61; // ADC Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short ADCIY = 0x71; // ADC Indirect Post-indexed; 2 bytes, 5
									  // cycles *

	// AND - "AND" memory with accumulator
	// * - add 1 cycle if page boundary is crossed
	public static short ANDI = 0x29; // AND Immediate; 2 bytes, 2 cycles
	public static short ANDZ = 0x25; // AND Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short ANDZX = 0x35; // AND Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short ANDA = 0x2D; // AND Absolute; 3 bytes, 4 cycles
	public static short ANDAX = 0x3D; // AND Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short ANDAY = 0x39; // AND Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short ANDIX = 0x21; // AND Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short ANDIY = 0x31; // AND Indirect Post-indexed; 2 bytes, 5
									  // cycles *

	// ASL - ASL Shift Left One Bit (Memory or Accumulator)
	public static short ASL = 0x0A; // ASL Accumulator; 1 byte, 2 cycles
	public static short ASLZ = 0x06; // ASL Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short ASLZX = 0x16; // ASL Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short ASLA = 0x0E; // ASL Absolute; 3 bytes, 6 cycles
	public static short ASLAX = 0x1E; // ASL Absolute X-indexed; 3 bytes, 7
									  // cycles
	...
	public static short BITZ = 0x24; // BIT Zero-page absolute; 2 bytes, 3
									 // cycles
	...
	public static short CMPZ = 0xC5; // CMP Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short CMPZX = 0xD5; // CMP Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short CMPA = 0xCD; // CMP Absolute; 3 bytes, 4 cycles
	public static short CMPAX = 0xDD; // CMP Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short CMPAY = 0xD9; // CMP Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short CMPIX = 0xC1; // CMP Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short CMPIY = 0xD1; // CMP Indirect Post-indexed; 2 bytes, 5
									  // cycles *

	// CPX - CPX Compare Memory and Index X
	public static short CPXI = 0xE0; // CPX Immediate; 2 bytes, 2 cycles
	public static short CPXZ = 0xE4; // CPX Zero-page absolute; 2 bytes, 3
									 // cycles
	...
	public static short CPYZ = 0xC4; // CPY Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short CPYA = 0xCC; // CPY Absolute; 3 bytes, 4 cycles

	// DEC - DEC Decrement memory by one
	public static short DECZ = 0xC6; // DEC Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short DECZX = 0xD6; // DEC Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short DECA = 0xCE; // DEC Absolute; 3 bytes, 6 cycles
	public static short DECAX = 0xDE; // DEC Absolute X-indexed; 3 bytes, 7
									  // cycles
	...
	public static short EORZ = 0x45; // EOR Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short EORZX = 0x55; // EOR Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short EORA = 0x4D; // EOR Absolute; 3 bytes, 4 cycles
	public static short EORAX = 0x5D; // EOR Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short EORAY = 0x59; // EOR Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short EORIX = 0x41; // EOR Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short EORIY = 0x51; // EOR Indirect Post-indexed; 2 bytes, 5
									  // cycles *

	// INC - INC Increment memory by one
	public static short INCZ = 0xE6; // INC Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short INCZX = 0xF6; // INC Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short INCA = 0xEE; // INC Absolute; 3 bytes, 6 cycles
	public static short INCAX = 0xFE; // INC Absolute X-indexed; 3 bytes, 7
									  // cycles
	...
	public static short LDAZ = 0xA5; // LDA Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short LDAZX = 0xB5; // LDA Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short LDAA = 0xAD; // LDA Absolute; 3 bytes, 4 cycles
	public static short LDAAX = 0xBD; // LDA Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short LDAAY = 0xB9; // LDA Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short LDAIX = 0xA1; // LDA Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short LDAIY = 0xB1; // LDA Indirect Post-indexed; 2 bytes, 5
									  // cycles *

	// LDX - LDX Load index X with memory
	// * - add 1 cycle if page boundary is crossed
	public static short LDXI = 0xA2; // LDX Immediate; 2 bytes, 2 cycles
	public static short LDXZ = 0xA6; // LDX Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short LDXZY = 0xB6; // LDX Zero-page Y-indexed; 2 bytes, 4
									  // cycles
	public static short LDXA = 0xAE; // LDX Absolute; 3 bytes, 4 cycles
	public static short LDXAY = 0xBE; // LDX Absolute Y-indexed; 3 bytes, 4
									  // cycles *

	// LDY - LDY Load index Y with memory
	// * - add 1 cycle if page boundary is crossed
	public static short LDYI = 0xA0; // LDY Immediate; 2 bytes, 2 cycles
	public static short LDYZ = 0xA4; // LDY Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short LDYZX = 0xB4; // LDY Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short LDYA = 0xAC; // LDY Absolute; 3 bytes, 4 cycles
	public static short LDYAX = 0xBC; // LDY Absolute X-indexed; 3 bytes, 4
									  // cycles *

	// LSR - LSR Shift right one bit (memory or accumulator)
	public static short LSR = 0x4A; // LSR Accumulator; 1 byte, 2 cycles
	public static short LSRZ = 0x46; // LSR Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short LSRZX = 0x56; // LSR Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short LSRA = 0x4E; // LSR Absolute; 3 bytes, 6 cycles
	public static short LSRAX = 0x5E; // LSR Absolute X-indexed; 3 bytes, 7
									  // cycles
	...
	public static short ORAZ = 0x05; // ORA Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short ORAZX = 0x15; // ORA Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short ORAA = 0x0D; // ORA Absolute; 3 bytes, 4 cycles
	public static short ORAAX = 0x1D; // ORA Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short ORAAY = 0x19; // ORA Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short ORAIX = 0x01; // ORA Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short ORAIY = 0x11; // ORA Indirect Post-indexed; 2 bytes, 5
									  // cycles
	...
	public static short ROLZ = 0x26; // ROL Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short ROLZX = 0x36; // ROL Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short ROLA = 0x2E; // ROL Absolute; 3 bytes, 6 cycles
	public static short ROLAX = 0x3E; // ROL Absolute X-indexed; 3 bytes, 7
									  // cycles

	// ROR - ROR Rotate one bit right (memory or accumulator)
	public static short ROR = 0x6A; // ROR Accumulator; 1 bytes, 2 cycles
	public static short RORZ = 0x66; // ROR Zero-page absolute; 2 bytes, 5
									 // cycles
	public static short RORZX = 0x76; // ROR Zero-page X-indexed; 2 bytes, 6
									  // cycles
	public static short RORA = 0x6E; // ROR Absolute; 3 bytes, 6 cycles
	public static short RORAX = 0x7E; // ROR Absolute X-indexed; 3 bytes, 7
									  // cycles
	...
	public static short SBCZ = 0xE5; // SBC Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short SBCZX = 0xF5; // SBC Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short SBCA = 0xED; // SBC Absolute; 3 bytes, 4 cycles
	public static short SBCAX = 0xFD; // SBC Absolute X-indexed; 3 bytes, 4
									  // cycles *
	public static short SBCAY = 0xF9; // SBC Absolute Y-indexed; 3 bytes, 4
									  // cycles *
	public static short SBCIX = 0xE1; // SBC Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short SBCIY = 0xF1; // SBC Indirect Post-indexed; 2 bytes, 5
									  // cycles
	...
	public static short STAZ = 0x85; // STA Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short STAZX = 0x95; // STA Zero-page X-indexed; 2 bytes, 4
									  // cycles
	public static short STAA = 0x8D; // STA Absolute; 3 bytes, 4 cycles
	public static short STAAX = 0x9D; // STA Absolute X-indexed; 3 bytes, 5
									  // cycles
	public static short STAAY = 0x99; // STA Absolute Y-indexed; 3 bytes, 5
									  // cycles
	public static short STAIX = 0x81; // STA Indirect Pre-indexed; 2 bytes, 6
									  // cycles
	public static short STAIY = 0x91; // STA Indirect Post-indexed; 2 bytes, 6
									  // cycles

	// STX - STX Store index X in memory
	public static short STXZ = 0x86; // STX Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short STXZX = 0x96; // STX Zero-page Y-indexed; 2 bytes, 4
									  // cycles
	public static short STXA = 0x8E; // STX Absolute; 3 bytes, 4 cycles

	// STY - STY Store index Y in memory
	public static short STYZ = 0x84; // STY Zero-page absolute; 2 bytes, 3
									 // cycles
	public static short STYZX = 0x94; // STY Zero-page X-indexed; 2 bytes, 4
									  // cycles
