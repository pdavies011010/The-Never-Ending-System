...
public enum AddressingMode {
	IMMEDIATE, ABSOLUTE, ZERO_PAGE, IMPLIED, ACCUMULATOR, ZERO_PAGE_X_INDEXED, ZERO_PAGE_Y_INDEXED, ABSOLUTE_X_INDEXED, 
	ABSOLUTE_Y_INDEXED, INDIRECT, PRE_INDEXED_INDIRECT, POST_INDEXED_INDIRECT, RELATIVE;
